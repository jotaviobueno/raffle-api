/*
  ...
  - Added the required column `event` to the `test` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "payment_gateway_config" ALTER COLUMN "deleted_at" SET DEFAULT NULL;
...
-- AlterTable
ALTER TABLE "test" ADD COLUMN     "event" TEXT NOT NULL,
