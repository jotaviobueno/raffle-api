/*
  ...
  - Added the required column `gatewayId` to the `gateway_event` table without a default value. This is not possible if the table is not empty.
  - Added the required column `short_description` to the `plan` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "gateway_event" ADD COLUMN     "gatewayId" TEXT NOT NULL,
...
-- AlterTable
ALTER TABLE "plan" ADD COLUMN     "short_description" TEXT NOT NULL,
ALTER COLUMN "deleted_at" SET DEFAULT NULL;
...
-- AlterTable
ALTER TABLE "user_role" ADD COLUMN     "expires_at" TIMESTAMP DEFAULT NULL,
ALTER COLUMN "deleted_at" SET DEFAULT NULL;
...
-- AddForeignKey
ALTER TABLE "gateway_event" ADD CONSTRAINT "gateway_event_gatewayId_fkey" FOREIGN KEY ("gatewayId") REFERENCES "gateway"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
